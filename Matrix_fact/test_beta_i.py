...
matrix[row_indices, col_indices] = np.random.uniform(0, 0.25, size=num_values_set)
...
matrix[40 + row_indices, col_indices] = np.random.uniform(0.75, 1, size=num_values_set)
...
print(matrix)
np.save('beta_i_matrix_init_cas_panique.npy', matrix)